...
INSERT INTO `t_payment`( `id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`) VALUES 
(13,'易支付支付宝', '支付宝', '/res/images/pay/alipay.jpg', 'alpayalipay', 'MD5'),
(14,'易支付微信', '微信支付', '/res/images/pay/weixin.jpg', 'alpaywxpay', 'MD5'),
(15,'易支付QQ', 'QQ支付', '/res/images/pay/qqpay.jpg', 'alpayqqpay', 'MD5');

INSERT INTO `t_payment` (`id`, `payment`, `payname`, `payimage`, `alias`, `sign_type`, `app_id`, `app_secret`, `ali_public_key`, `rsa_private_key`, `configure3`, `configure4`, `overtime`, `active`) VALUES
(16, 'PAYJS(微信)', '微信', '/res/images/pay/weixin.jpg', 'payjswx', 'MD5', '', '', NULL, NULL, '', '', 0, 0),
(17, 'PAYJS(支付宝)', '支付宝', '/res/images/pay/alipay.jpg', 'payjsalipay', 'MD5', '', '', NULL, NULL, '', '', 0, 0);
-- --------------------------------------------------------
